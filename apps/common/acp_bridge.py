...
# Must run BEFORE importing taumain — it reconfigures stdout at import time,
...
# prints from taumain/llmcore don't pollute the ACP channel.
...
class _StdoutToStderrRouter(io.TextIOBase):
    """Redirect text-mode stdout to stderr so taumain prints don't leak."""
