...
USER_TASKS = {}
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # app.py → apps/pet/ → apps/ → Tau/
...
class DiscordApp(AgentChatMixin):
    ...
    def __init__(self):
        ...
        self._agents = OrderedDict()  # chat_id -> Tau, each chat has isolated history
