...
(() => {
    ...
    const BADGE_ID = 'tau-header-badge';
    const STYLE_ID = 'tau-header-badge-style';
    ...
    if (hostWin.__tauHeaderBadgeTimer) {
        hostWin.clearInterval(hostWin.__tauHeaderBadgeTimer);
    }
    hostWin.__tauHeaderBadgeTimer = hostWin.setInterval(ensureBadge, 500);
...
st.session_state.agent_name = 'Tau'
