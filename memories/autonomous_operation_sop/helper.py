...
放置: memories/autonomous_operation_sop/
...
# ── 路径计算（基于模块自身位置） ──
_MODULE_DIR = Path(__file__).resolve().parent          # memories/autonomous_operation_sop/
_MEMORY_DIR = _MODULE_DIR.parent                       # memories/
_AGENT_DIR = _MEMORY_DIR.parent                        # Tau/
_TEMP_DIR = _AGENT_DIR / "temp"                        # Tau/temp/
