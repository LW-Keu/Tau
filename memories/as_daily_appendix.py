...
位置: memories/as_daily_appendix.py
依赖: 仅 Python 标准库 + macOS osascript
用法:
    python memories/as_daily_appendix.py reminders         # 人读格式
    python memories/as_daily_appendix.py calendar --json   # JSON 格式
    python memories/as_daily_appendix.py both --json       # 合并 JSON
