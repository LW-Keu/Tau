...
class ToolClient:
    ...
    def _prepare_tool_instruction(self, tools):
        ...
        _en = os.environ.get('TAU_LANG', os.environ.get('GA_LANG', '')) == 'en'
        if _en:
            tool_instruction = f"""
...
class NativeToolClient:
    @staticmethod
    def _thinking_prompt(): return THINKING_PROMPT_EN if os.environ.get('TAU_LANG', os.environ.get('GA_LANG', '')) == 'en' else THINKING_PROMPT_ZH
